...
public class BurningShip extends FractalGenerator
{
     ...
     *       * Эта реализация устанавливает начальный диапазон равным x = -2, y = -2,5,
     *       * ширина = высота = 4.
     */
    ...
    public int numIterations(double x, double y)
    {
        ...
        /**
         Результаты перевода
         * Вычислить Zn = (abs [Re (zn-1)] + i (abs [img (zn-1)])) ^ 2 + c, где значения
     ...
     * название фрактала: «Горящий корабль».
     */
